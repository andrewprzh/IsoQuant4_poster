...
\titleright{%
  \begin{minipage}[t]{0.062\paperwidth}\centering
      \qrcode[height=4.2cm]{https://github.com/ablab/IsoQuant}\\[1ex]
      {\scriptsize\bfseries IsoQuant}
  \end{minipage}\hfill
  \begin{minipage}[t]{0.062\paperwidth}\centering
      \qrcode[height=4.2cm]{https://github.com/tilgnerlab/Spl-IsoFind}\\[1ex]
      {\scriptsize\bfseries Spl-IsoFind}
  \end{minipage}\hfill
  \begin{minipage}[t]{0.062\paperwidth}\centering
      \qrcode[height=4.2cm]{https://doi.org/10.1038/s41592-026-03211-w}\\[1ex]
