...
\begin{figure}
    \centering
    \includegraphics[width=0.95\textwidth]{figures/variability.pdf}
...
The later is detected via Moran's~$I$ spatial autocorrelation and permutation tests.
\begin{figure}
    \centering
    \includegraphics[width=0.95\textwidth]{figures/splisofind.pdf}
