...
\author{
  \underline{Andrey Prjibelski}\textsuperscript{1}, Lieke Michielsen\textsuperscript{2}, \\
  Careen Foord\textsuperscript{2}, Alexandru I. Tomescu\textsuperscript{1}, \\
  Iman Hajirasouliha\textsuperscript{3}, Hagen U. Tilgner\textsuperscript{2}
}
\institute{
...
long-read RNA-seq data, \textbf{Spl-IsoFind}~\cite{michielsen2026} --- a package for discovering spatially variable isoforms and their application to mouse brain data.
